...
| **Non-functional** | <ul><li> The search should return the reuslts as quick as possible to avoid the user waiting. The app was made so that users can make quick decisions.  |
